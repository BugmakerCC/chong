...
- ***[Coinvisor: An RL-Enhanced Chatbot Agent for Interactive Cryptocurrency Investment Analysis](https://arxiv.org/abs/2510.17235)*** <br>
  **Chong Chen**, Ze Liu, Lingfeng Bao, Yanlin Wang, Ting Chen, Daoyuan Wu, Jiachi Chen (**Pre-print 2025**) <br>
...
- ***[Trace: Securing Smart Contract Repository Against Access Control Vulnerability](https://arxiv.org/abs/2510.19254)*** <br>
  **Chong Chen**, Jiachi Chen, Lingfeng Bao, David Lo, Yanlin Wang, Zhenyu Shan, Ting Chen, Guangqiang Yin, Jianxing Yu, Zibin Zheng (**Pre-print 2025**) <br>
...
- ***[Identifying Smart Contract Security Issues in Code Snippets from Stack Overflow](https://dl.acm.org/doi/pdf/10.1145/3650212.3680353)*** <br>
  ...
  in ACM SIGSOFT International Symposium on Software Testing and Analysis (**ISSTA 2024**) <br>
  **ACM SIGSOFT Distinguished Paper Award** <br>
  <a href="https://dl.acm.org/doi/pdf/10.1145/3650212.3680353" class="no-trailing-icon"><img src="https://img.shields.io/badge/PDF-ACM-blue.svg?style=flat-square" alt="ACM PDF"/></a> <a href="https://github.com/BugmakerCC/SOChecker" class="no-trailing-icon"><img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/BugmakerCC/SOChecker?style=flat-square&logo=github&label=GitHub%20Stars&labelColor=black"></a>

- ***[When ChatGPT Meets Smart Contract Vulnerability Detection: How Far Are We?](https://arxiv.org/pdf/2309.05520)*** <br>
  **Chong Chen**, Jianzhong Su, Jiachi Chen, Yanlin Wang, Tingting Bi, Jianxing Yu, Yanli Wang, Xingwei Lin, Ting Chen, Zibin Zheng <br>
  in ACM Transactions on Software Engineering and Methodology (**TOSEM 2024**) <br>
  <a href="https://arxiv.org/pdf/2309.05520" class="no-trailing-icon"><img src="https://img.shields.io/badge/arXiv-2309.05520-b31b1b.svg?style=flat-square" alt="arXiv-2309.05520"/></a> <a href="https://zenodo.org/record/8332273" class="no-trailing-icon"><img src="https://img.shields.io/badge/Zenodo-Dataset-blue.svg?style=flat-square" alt="Zenodo Dataset"/></a> <a href="https://github.com/BugmakerCC/GPT4scv" class="no-trailing-icon"><img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/BugmakerCC/GPT4scv?style=flat-square&logo=github&label=GitHub%20Stars&labelColor=black"></a>

# 🎖 Honors and Awards {#honors-and-awards}

- *2025* **Xiaomi Outstanding Scholarship** at *Sun Yat-sen University*
- *2024* **National Scholarship** at *Sun Yat-sen University*
- *2025* **Top 5**, ETH Hangzhou Hackathon, 896 likes ([Project Link](https://www.hackquest.io/zh-cn/projects/ETH-Hangzhou-Hackathon-2025-QuantifyX))
- *2024* **1st Class Scholarship** at *Sun Yat-sen University*
- *2024* **The Third Prize** in the *DataCon* Big Data Security Analysis Competition
- *2024* **ACM SIGSOFT Distinguished Paper Award** at *ISSTA 2024*
- *2023* **1st Class Scholarship** at *Sun Yat-sen University*
...
- **Email**: [chench578@mail2.sysu.edu.cn](mailto:chench578@mail2.sysu.edu.cn)
- **WeChat**: [QR Code](/chong/images/wechat-qr.jpg) 